...
export const en = {
  ...
  evidence: {
    ...
    checkSummary: {
      workerReportReceived: "Worker report received.",
      workerReportMissing: "No worker report (preflight-only run).",
      noProtectedPathChanges: "No protected path changes detected.",
      protectedPathChanged: "Protected path changed.",
      protectedPathModified: "Protected path modified.",
      changeWithinAllowedPaths: "Change within allowed paths.",
      changeOutsideAllowedPaths: "Change outside allowed paths.",
      commandExecutionSkipped: "Command execution skipped for demo/fixture run.",
      noRequiredCommands: "No required commands configured for this contract.",
      commandNotApplicable: "Command not applicable for this workspace: {command}",
      commandFailed: "Command failed: {command}",
      commandSucceeded: "Command succeeded: {command}",
      commandTimedOut: "Command timed out: {command}",
      gitDiffTitle: "File changes from baseline",
      gitDiffChanged: "{count} files changed from baseline {sha}.",
    },
    sections: {
