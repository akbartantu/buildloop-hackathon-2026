export const publicId = {
  meta: {
    title: "BuildLoop — AI tergoverned untuk software delivery",
    description:
      "BuildLoop menyelesaikan task pengembangan perangkat lunak terbatas secara otonom sambil menjaga kontrol manusia atas aksi sensitif keamanan dan aksi ireversibel.",
  },
  header: {
  ...
  hero: {
    eyebrow: "AI tergoverned untuk software delivery",
    titleLine1: "Kirim task perangkat lunak secara otonom.",
    titleLine2: "Manusia tetap mengendalikan.",
    subtitle:
      "BuildLoop menyelesaikan task pengembangan perangkat lunak terbatas dari goal hingga hasil terverifikasi, berhenti pada aksi berisiko atau ireversibel, dan meminta persetujuan manusia.",
    signUp: "Mulai gratis",
    signIn: "Masuk",
    startFree: "Mulai gratis",
  ...
  heroPreview: {
    illustrative: "Contoh ilustratif",
    runLabel: "Run BL-2026-E912",
    duration: "dalam 28 dtk",
    resultPass: "PASS",
    resultSummary: "Semua check lulus. Tidak ada protected path yang dimodifikasi.",
    changesTitle: "Perubahan",
    filesChanged: "2 file berubah",
    file1: "src/auth/login.ts",
    file1Diff: "+12 −3",
    file2: "src/auth/session.ts",
    file2Diff: "+4 −1",
    nextTitle: "Berikutnya",
    awaitingApproval: "Menunggu persetujuan manusia",
    deliveryTitle: "Aksi delivery",
  ...
  trust: {
    title: "Prinsip kepercayaan inti",
    t1Title: "Deterministik by design",
    t1Text: "Contract, check, dan guardrail menjaga hasil tetap prediktif.",
    t2Title: "Terverifikasi, bukan ditebak",
    t2Text: "Check independen dan evidence untuk setiap run.",
    t3Title: "Kontrol manusia built-in",
    t3Text: "Aksi sensitif berhenti sampai disetujui secara eksplisit.",
    t4Title: "Powered by Google",
    t4Text: "Gemini, Google ADK, dan Google Cloud.",
  },
  scope: {
  ...
  howItWorks: {
    eyebrow: "Cara kerja",
    title: "Cara BuildLoop bekerja",
    description: "Lifecycle tergoverned dari task goal hingga delivery yang aman.",
    steps: {
      taskGoal: {
        title: "Task Goal",
        text: "Pengguna menjelaskan goal.",
      },
      contract: {
        title: "Contract",
        text: "BuildLoop membuat scope terbatas dan acceptance criteria.",
      },
      worker: {
        title: "Worker",
        text: "Coding worker mengeksekusi perubahan.",
      },
      checker: {
        title: "Checker",
        text: "Checker independen memverifikasi hasil.",
      },
      correction: {
        title: "Correction",
        text: "Maksimum 2 self-correction attempt.",
      },
      decision: {
        title: "Decision",
        text: "PASS, FAILED, atau BLOCKED.",
      },
      approval: {
        title: "Approval",
        text: "Manusia meninjau aksi sensitif.",
      },
      delivery: {
        title: "Delivery",
        text: "Hanya aksi yang disetujui yang boleh lanjut.",
      },
    },
  },
  outcomes: {
    eyebrow: "Hasil",
    title: "Dibuat untuk skenario nyata",
    description: "BuildLoop tahu kapan harus mengeksekusi dan kapan harus berhenti.",
    pass: {
      title: "PASS",
      subtitle: "Perubahan aman, terverifikasi",
      p1: "Contract terpenuhi",
      p2: "Check lulus",
      p3: "Tidak ada aksi berisiko terdeteksi",
      p4: "Siap untuk review manusia",
    },
    failed: {
      title: "FAILED",
      subtitle: "Tidak memenuhi contract",
      p1: "Checker mendeteksi kriteria belum terpenuhi",
      p2: "Upaya koreksi terbatas habis",
      p3: "Hasil tidak aman tidak diterima",
    },
    blocked: {
      title: "BLOCKED",
      subtitle: "Aksi berisiko terdeteksi",
      p1: "Protected path terdeteksi",
      p2: "Risiko kredensial atau secret",
      p3: "Aksi ireversibel membutuhkan approval",
      p4: "Tidak ada aksi sensitif dieksekusi otomatis",
    },
  },
  technology: {
    eyebrow: "Teknologi",
    title: "Dibangun di atas teknologi terpercaya",
    description: "Eksekusi powered by Google dengan kontrol tergoverned.",
    items: {
      gemini: {
        name: "Gemini",
        description: "AI worker dipakai selama orchestration run yang disetujui.",
      },
      googleAdk: {
        name: "Google ADK",
      ...
      cloudRun: {
        name: "Cloud Run",
        description: "Runtime aplikasi produksi.",
      },
      firestore: {
        name: "Firestore",
        description: "Persistensi runtime run dan evidence.",
      },
    },
  },
  about: {
    title: "Tentang BuildLoop",
    description:
      "BuildLoop adalah orchestrator software-delivery otonom yang tergoverned — bukan chatbot atau generator kode generik. BuildLoop menyelesaikan task terbatas sambil menjaga commit, push, merge, dan deploy di bawah kontrol manusia.",
  },
  finalCta: {
    title: "Siap mengirim dengan percaya diri?",
    description: "Gunakan BuildLoop untuk delivery perubahan perangkat lunak yang aman, terverifikasi, dan dapat diaudit.",
    startFree: "Mulai gratis",
    signIn: "Masuk",
  },
  publicFooter: {
  ...
  features: {
    eyebrow: "Fitur",
    title: "Governance yang tidak mengganggu",
    description:
      "BuildLoop menegakkan batas tanpa membuat setiap run membutuhkan pengawasan manual terus-menerus.",
  ...
  faq: {
    ...
    q4: "Apa yang didukung BuildLoop saat ini?",
    a4: "BuildLoop mengorganisir pekerjaan per workspace. Setiap workspace terhubung ke satu repositori GitHub publik, menjalankan task terbatas melalui contract dan lifecycle checker independen, mengizinkan hingga dua self-correction attempt, serta menjaga commit, push, merge, dan deploy di bawah persetujuan manusia.",
